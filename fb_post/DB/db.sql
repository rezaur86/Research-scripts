...
alter table link drop CONSTRAINT link_row_id_pkey;
...
alter table link add CONSTRAINT link_message_row_id_fkey FOREIGN KEY (message_row_id) REFERENCES message(row_id) ON UPDATE CASCADE ON DELETE RESTRICT;
